...
def _build_balance_weights(velocity: np.ndarray) -> np.ndarray:
    ...
    # Give moderate extra emphasis to medium/high speeds where Coulomb and
    # viscous terms separate more cleanly.
    ...
    for joint_idx in range(num_joints):
        ...
        for candidate_scale in candidate_velocity_scales:
            for include_offset in (False, True):
                ...
                # Prefer simpler, more physical models unless the richer model
                # gives a clear error reduction.
