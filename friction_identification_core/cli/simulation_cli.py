...
from friction_identification_core.runtime import ensure_results_dir, log_info, write_json
from friction_identification_core.tracking import (
    build_tracking_evaluation,
    choose_tracking_winner,
    serialize_tracking_evaluation,
)
...
def main() -> None:
    ...
    try:
        ...
        write_json(output_dir / "friction_identification_summary.json", summary)
